...
public class ShowDepense extends javax.swing.JFrame {
    ...
    public ShowDepense() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numéro de Dépense :");
    ...
    public static void main(String args[]) throws ClassNotFoundException {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new ShowDepense().setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(ShowDepense.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
    }
