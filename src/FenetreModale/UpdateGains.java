...
//Starting
import static FenetreModale.UpdateDepense.instant;
import Form.Form_4;
import Form.Form_7;
...
public final class UpdateGains extends javax.swing.JFrame {
    ...
    public UpdateGains() throws SQLException {
        initComponents();
   ...
   public void RecuperationDonne() throws SQLException {
    ...
    private void initComponents() {
        ...
        MotantD.setLabelText("Montant de la gain en Ariary");
        ...
        dateDepense.setLabelText("Date Gain");
    ...
    private void BtnAjouterDepenseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAjouterDepenseActionPerformed
        ...
        try {
            ...
            try {
                ...
                resul = prepare.executeQuery();
                if (resul.next()) {
                    L1 = resul.getString("IDG");
                    NumDepense.setText(A1);

                    String requete = "UPDATE gains SET IDG='" + A1 + "', DescrG='" + A4 + "',MotantG ='" + A5 + "',DateG='" + A6 + "', NumD_ref='" + A2 + "' WHERE IDG='" + A1 + "' ";
                    try {
    ...
    public static void main(String args[]) throws ClassNotFoundException {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new UpdateGains().setVisible(true);
            } catch (SQLException ex) {
                java.util.logging.Logger.getLogger(UpdateGains.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            }
        });
    }
